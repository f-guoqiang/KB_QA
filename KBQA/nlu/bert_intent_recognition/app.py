...
class BertIntentModel(object):
    def __init__(self):
        ...
        self.dict_path = 'F:/GitHub/KBQA/KBQA/vocab.txt'
        self.config_path= 'F:/GitHub/KBQA/KBQA/bert_config_rbt3.json'
        self.checkpoint_path= 'F:/GitHub/KBQA/KBQA/bert_model.ckpt'
