...
if __name__ == '__main__':
	config_path='/root/autodl-tmp/KBQA/nlu/bert_intent_recognition/checkpoint/bert_config_rbt3.json'
	checkpoint_path='/root/autodl-tmp/KBQA/nlu/bert_intent_recognition/checkpoint/best_model.weights'
	class_nums=13
